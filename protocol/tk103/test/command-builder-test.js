...
var testAnswerHandshakeSignalMessage = function() {
	var message = buildCommand(constants.commands.ANSWER_HANDSHAKE_SIGNAL_MESSAGE, {
		trackerId : "013612345678",
	});
	assert.equal(message, "(013612345678AP01HSO)");
};

var testDeviceLoginResponseMessage = function() {
	var message = buildCommand(constants.commands.DEVICE_LOGIN_RESPONSE_MESSAGE, {
		trackerId : "013612345678",
	});
	assert.equal(message, "(013612345678AP05)");
};

var testsameTimeContinuesFeedbackConfigure = function() {
	var message = buildCommand(constants.commands.SAME_TIME_CONTINUES_FEEDBACK_CONFIGURE, {
		enabled : true,
		interval: '20s',
		duration: '36m',
		trackerId : "013612345678"
